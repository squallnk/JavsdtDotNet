...
{
    public class JavasdtContext : DbContext
    {
        // 单数据库用下面
        //protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        //{
        //    optionsBuilder.UseSqlite(@$"Data Source={EnvSettings.ProjectDirectory}\Javasdt.db");
        //}

        // Asp用下面
        public JavasdtContext(DbContextOptions<JavasdtContext> options) : base(options)
        {
